...
// A lot of this stuff is taken straight from easyVCR, once I understand it I'll be rewriting it
public class RequestCensorElement
{
    /// <summary>
    ...
    public RequestCensorElement(string value, bool caseSensitive)
    {
        Value = value;
...
public class RegexRequestCensorElement : RequestCensorElement
{
    /// <summary>
    ...
    public RegexRequestCensorElement(string pattern, bool caseSensitive)
        : base(pattern, caseSensitive) { }
    ...
    internal string MatchAndReplaceAsNeeded(string value, string replacement)
    {
        ...
        return Regex.Replace(value, Value, replacement, options, TimeSpan.FromMilliseconds(250));
    }
    ...
    internal override bool Matches(string value)
    {
        ...
        try
        {
            return Regex.IsMatch(value, Value, options, TimeSpan.FromMilliseconds(250));
        }
