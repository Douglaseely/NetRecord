...
internal static class StaticDefaults
{
    ...
    /// </summary>
    internal static readonly Dictionary<string, object> ReplayHeaders = new Dictionary<
        string,
        object
    >
    {
    ...
    /// </summary>
    internal static List<string> CredentialHeadersToHide =>
        new List<string> { "authorization", "x-api-key" };

    /// <summary>
    ///     Default list of parameters to censor in the cassettes.
    /// </summary>
    internal static List<string> CredentialParametersToHide =>
        new List<string>
        {
            "access_token",
            "apiKey",
